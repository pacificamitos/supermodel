...
<!------------------------------------ DataModel ----------------------------------------------
  ...
  Description:  Adds CRUD (Create/Read/Update/Delete) methods to the object so that each
                instance of the object is tied to a single record in the database table.
...
---------------------------------------------------------------------------------------------->
  ...
  <cffunction name="insertQuery" access="private" returntype="void">
    ...
    <cfargument name="fields" requried="no" />
...
---------------------------------------------------------------------------------------------->
  ...
  <cffunction name="updateQuery" access="private" returntype="boolean">
...
---------------------------------------------------------------------------------------------->
  ...
  <cffunction name="addProperty" access="private" returntype="void">
    ...
    <!--- Add the property to the object itself --->
    <cfset structInsert(this, arguments.name, "", true) />

    <!--- Initialise the structures if they don't exist yet --->
    ...
    <!--- Add the type to the field_types struct; is used for simplifying queries --->
    <cfset structInsert(
