...
----------------------------------------------------------------------------------------------------->	
	...
	<cffunction name="read" access="public">
		...
		WHERE #variables.table_name#.#This.primary_key# = #This.id#
		</cfquery>
...
----------------------------------------------------------------------------------------------------->	
	...
	<cffunction name="updateQuery">
		<cfargument name="table" default="#variables.table_name#" />
		<cfargument name="fields" default="#variables.database_fields#" />
		<cfargument name="primary_key" default="#This.primary_key#" />
...
----------------------------------------------------------------------------------------------------->	
	...
	<cffunction name="initDatabaseFields">
		...
		<cfif NOT IsDefined("variables.field_types") OR NOT IsStruct(variables.field_types)>
		...
		<cfset This.primary_key = ValueList(getPK.Column_Name,',') />
	</cffunction>
