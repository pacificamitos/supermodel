...
<!---------------------------------------------------------------------------------------- init
  ...
  Description:  Sets the name of the object and the filesystem folder that the object's CFC
                file is stored in.  This function is called implicitly whenever an object
...
<!---------------------------------------------------------------------------------------- load
  ...
  Description:  Takes in a structure of attribute-value pairs and updates the object's
                attributes to match those in the given structure.  If the structure contains
...
<!----------------------------------------------------------------------------------- getErrors
  ...
  Description:  Returns errors triggered by the object
